...
export default function FinchAppLayout({ routes, headerTitle, headerLogoUrl, headerLogoIcon, classNameMainContent, classNameMainContentInnerContainer, classNameHeader, classNameHeaderTitle, classNameSidebar, classNameSidebarActiveLink, classNameSidebarInactiveLink, classNameImage, className, ...props }: FinchAppLayoutProps): import("react/jsx-runtime").JSX.Element;
//# sourceMappingURL=FinchAppLayout.d.ts.map