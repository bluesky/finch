import { ActionRequestSubscribe, ActionRequestUnsubscribe, ActionRequestSet, ActionRequestRefresh, MessageResponse, ErrorResponse, ValueUpdateResponse, MetaUpdateResponse } from '../ophydPVSocketTypes';
export type OphydPVOutgoingMessage = ActionRequestSubscribe | ActionRequestUnsubscribe | ActionRequestSet | ActionRequestRefresh;
export type OphydPVIncomingMessage = MessageResponse | ErrorResponse | ValueUpdateResponse | MetaUpdateResponse;
