...
describe('ButtonWithIcon Component', () => {
  ...
  it('calls callback function when clicked', () => {
    ...
    render(<ButtonWithIcon text="Test Button" icon={<TestIcon />} cb={mockCallback} />);
  ...
  it('does not call callback when disabled and clicked', () => {
    const mockCallback = vi.fn();
    render(<ButtonWithIcon text="Disabled Button" icon={<TestIcon />} cb={mockCallback} disabled={true} />);
  ...
  it('applies correct size classes for text', () => {
    const { container: smallContainer } = render(<ButtonWithIcon text="Small" icon={<TestIcon />} size="small" />);
    const { container: mediumContainer } = render(<ButtonWithIcon text="Medium" icon={<TestIcon />} size="medium" />);
    const { container: largeContainer } = render(<ButtonWithIcon text="Large" icon={<TestIcon />} size="large" />);
  ...
  it('merges custom className with default classes', () => {
    ...
    const { container } = render(<ButtonWithIcon text="Custom" icon={<TestIcon />} className={customClass} />);
    const button = container.firstChild;
  ...
  it('applies custom text className', () => {
    ...
    render(<ButtonWithIcon text="Custom Text" icon={<TestIcon />} classNameText={customTextClass} />);
  ...
  it('prevents default on click', () => {
    const mockCallback = vi.fn();
    render(<ButtonWithIcon text="Test" icon={<TestIcon />} cb={mockCallback} />);
  ...
  it('passes through additional props', () => {
    render(<ButtonWithIcon text="Test" icon={<TestIcon />} data-testid="custom-button" aria-label="Custom Label" />);
