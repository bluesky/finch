...
describe('ButtonCopyToClipboard Component', () => {
  ...
  it('applies correct size classes', () => {
    const { container: smallContainer } = render(<ButtonCopyToClipboard copyText="test" size="small" />);
    const { container: mediumContainer } = render(<ButtonCopyToClipboard copyText="test" size="medium" />);
    const { container: largeContainer } = render(<ButtonCopyToClipboard copyText="test" size="large" />);
  ...
  it('merges custom className with default classes', () => {
    ...
    const { container } = render(<ButtonCopyToClipboard copyText="test" className={customClass} />);
    const button = container.firstChild;
  ...
  it('passes through additional props', () => {
    render(<ButtonCopyToClipboard copyText="test" data-testid="custom-copy-button" aria-label="Copy to clipboard" />);
