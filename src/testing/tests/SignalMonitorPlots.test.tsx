...
describe('SignalMonitorPlotDevice', () => {
  it('renders without crashing', () => {
    const { container } = render(<SignalMonitorPlotDevice device={null} deviceLabel="PV:TEST" demo />);
  ...
  it('passes yAxisTitle prop to PlotlyScatter when provided', () => {
    render(
      <SignalMonitorPlotDevice device={{ value: 42, units: 'mm' }} deviceLabel="PV" yAxisTitle="Distance" />
    );
  ...
  it('accumulates data points over time in demo mode', () => {
    render(
      <SignalMonitorPlotDevice device={null} deviceLabel="PV" demo pollingIntervalMilliseconds={1000} />
    );
