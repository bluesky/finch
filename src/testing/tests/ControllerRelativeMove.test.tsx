...
describe('ControllerRelativeMove Component', () => {
  ...
  it('right arrow calls handleEnter with currentValue + inputValue', () => {
    ...
    const { container } = render(<ControllerRelativeMove currentValue={10} handleEnter={handleEnter} />);
  ...
  it('applies a custom className', () => {
    const { container } = render(<ControllerRelativeMove currentValue={0} className="my-custom-class" />);
    expect(container.firstChild).toHaveClass('my-custom-class');
  });

  it('handles negative currentValue correctly', () => {
    const handleEnter = vi.fn();
    const { container } = render(<ControllerRelativeMove currentValue={-5} handleEnter={handleEnter} />);
