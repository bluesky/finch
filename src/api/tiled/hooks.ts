...
export function useSearchByIdQuery(
  config: Omit<TiledSearchConfig, 'baseUrl' | 'apiKey'>,
  queryOptions?: Partial<UseQueryOptions<TiledSearchResult | null, Error, TiledSearchResult | null, unknown[]>>,
) {
  const { baseUrl, apiKey } = useTiledBase();
  return useQuery({
...
export function useSearchByMetadataComparisonQuery(
  ...
  const { baseUrl, apiKey } = useTiledBase();
  return useQuery({
    queryKey: ['tiled', 'searchByMetadataComparison', baseUrl, key, operator, value, path, options],
    queryFn: () => searchByMetadataComparison(baseUrl, key, operator, value, path, options, apiKey),
    ...queryOptions,
  });
}
...
export function useItemMetadataQuery(
  searchPath: string,
  queryOptions?: Partial<UseQueryOptions<TiledSearchMetadataResult | null, Error, TiledSearchMetadataResult | null, unknown[]>>,
) {
...
export function useBlueskyPlanMetadataQuery(
  searchPath: string,
  queryOptions?: Partial<UseQueryOptions<TiledBlueskyPlanMetadataResponse | null, Error, TiledBlueskyPlanMetadataResponse | null, unknown[]>>,
) {
  const { baseUrl } = useTiledBase();
  return useQuery({
...
export function useTableDataAsSequenceQuery(
  searchPath: string,
  partition: number,
  queryOptions?: Partial<UseQueryOptions<TiledTableRow[] | null, Error, TiledTableRow[] | null, unknown[]>>,
) {
  const { baseUrl } = useTiledBase();
  return useQuery({
...
export function useTableDataAsJsonQuery(
  searchPath: string,
  partition: number,
  queryOptions?: Partial<UseQueryOptions<TiledTableJSONResponse | null, Error, TiledTableJSONResponse | null, unknown[]>>,
) {
  const { baseUrl } = useTiledBase();
  return useQuery({
...
export function useStructuredArrayDataQuery(
  searchPath: string,
  block: number,
  queryOptions?: Partial<UseQueryOptions<TiledStructuredArrayData | null, Error, TiledStructuredArrayData | null, unknown[]>>,
) {
  const { baseUrl } = useTiledBase();
  return useQuery({
...
export function useServerInfoQuery(
  queryOptions?: Partial<UseQueryOptions<TiledInfoResponse | null, Error, TiledInfoResponse | null, unknown[]>>,
) {
  const { baseUrl } = useTiledBase();
  return useQuery({
