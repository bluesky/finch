 ...
 */
export default function HubHeader({ title, logoUrl, logoIcon, className, classNameImage, classNameTitle, rightSlot, ...props }: FinchHeaderProps): import("react/jsx-runtime").JSX.Element;
