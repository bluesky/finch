import{j as d}from"./jsx-runtime-Cf8x2fCZ.js";import{R as E,r}from"./index-BlmOqGMO.js";import{P as L}from"./react-plotly-DHQ8Bxuu.js";import{c as R}from"./utils-DuMXYCiK.js";import"./index-yBjzXJbu.js";const _=[{x:[1,2,3],y:[2,6,3],type:"scatter",mode:"lines+markers",marker:{color:"red"}}],u={size:16,color:"#082f49"},P=E.memo(function({data:w=_,title:T,xAxisTitle:s,yAxisTitle:o,xAxisRange:n,yAxisRange:i,xAxisLayout:v,yAxisLayout:A,className:S,...k}){const a=r.useRef(null),[l,q]=r.useState({width:0,height:0});return r.useEffect(()=>{const m=new ResizeObserver(c=>{if(c[0]){const{width:N,height:D}=c[0].contentRect;q({width:N,height:D})}});return a.current&&m.observe(a.current),()=>m.disconnect()},[]),d.jsx("div",{className:R("max-h-full h-96 rounded-lg overflow-hidden text-slate-700",S),ref:a,...k,children:d.jsx(L,{data:w,layout:{title:T,plot_bgcolor:"#E2E8F0",paper_bgcolor:"#E2E8F0",xaxis:{title:{text:s,font:u},range:n||void 0,...v},yaxis:{title:{text:o,font:u},range:i||void 0,...A},autosize:!0,width:l.width,height:l.height,margin:{l:o?60:50,r:30,t:30,b:s?70:30}},config:{responsive:!0}})})});P.__docgenInfo={description:"",methods:[],displayName:"PlotlyScatter",props:{data:{required:!1,tsType:{name:"PlotParams['data']",raw:"PlotParams['data']"},description:"Plotly trace array to render. Defaults to a sample line+marker dataset.",defaultValue:{value:`[
    {
        x: [1, 2, 3],
        y: [2, 6, 3],
        type: 'scatter',
