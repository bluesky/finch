 ...
 */
export default function FinchHeader({ title, pageTitle, logoUrl, logoIcon, className, classNameImage, classNameTitle, classNamePageTitle, rightSlot, ...props }: FinchHeaderProps): import("react/jsx-runtime").JSX.Element;
//# sourceMappingURL=FinchHeader.d.ts.map