...
declare const postQueueItem: (body: AddQueueItemBody, cb: (data: PostItemAddResponse) => void, mock?: boolean) => Promise<"success" | "failed" | undefined>;
declare const executeItem: (body: ExecuteQueueItemBody, cb: (data: PostItemExecuteResponse) => void, mock?: boolean) => Promise<"success" | "failed" | undefined>;
declare const getQueueItem: (uid: string | undefined, cb: (data: GetQueueItemResponse) => void, mock?: boolean) => Promise<void>;
declare const deleteQueueItem: (body: RemoveQueueItemBody, cb: (data: PostItemRemoveResponse) => void, mock?: boolean) => Promise<"success" | "failed" | undefined>;
