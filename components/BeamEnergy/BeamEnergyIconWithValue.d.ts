...
export default function BeamEnergy({ pv, }: BeamEnergyIconWithValueProps): import("react/jsx-runtime").JSX.Element;
//# sourceMappingURL=BeamEnergyIconWithValue.d.ts.map