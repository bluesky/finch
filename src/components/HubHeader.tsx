 ...
 */
export default function HubHeader({title="BEAMLINE APP", logoUrl="https://img.icons8.com/?size=100&id=11743&format=png&color=000000", logoIcon, className, classNameImage, classNameTitle, rightSlot, ...props}: HubHeaderProps) {
    return (
